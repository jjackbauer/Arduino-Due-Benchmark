...
// has to be 20 for the used T student values
#define N_BATCH_ITERATIONS 10000 
// the bigger the better, but it will take more time to finish
...
double A = 1, B = 1, C = 1;
double uTime[20], uMeanTime, standardDeviation;
double HV5, LV5,HV1,LV1,overheadMeanTime;
double studentT195 = 2.0930; 
// gl = 19, alpha = 5 
double studentT191 = 2.5395;
// gl = 19, alpha = 1
//Retirados do livro 
//Modelagem e Simulação Discreta do professor Brauliro, 2016.
